<template>
  <div>
    ...
    <div id="activity">
      <h1>Evénements</h1>
      <p class="subTitle">
        Confs, meetups, et rencontres cools auxquelles je vais
      </p>
      <div class="activityBlock">
        <div class="activityBlockContainer">
          ...
          <div class="comment">
            ...
            <h6>
              (09/2016 et 09/2017, Allemagne et 06/2016 et 06/2017, France)
            </h6>
            <h5>
              Conférences, WorkShops - développement d’applications web et
              logiciel, Eclipse, IoT, JAVA, PHP, JavaScript
            </h5>
          </div>
        </div>
        <div class="activityBlockContainer">
          ...
          <div class="comment">
            ...
            <h5>
              Hackaton, travail d'équipe, JavaScript, Algorithmique avancée
            </h5>
          </div>
        </div>
        <div class="activityBlockContainer">
        ...
        <div class="activityBlockContainer">
          ...
          <div class="comment">
            ...
            <h5>
              développement d’applications web et logiciel, UX, Gestion de
              projet et de relations clients
            </h5>
          </div>
        </div>
        <div class="activityBlockContainer">
